CLASS lhc_question DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_question_keys TYPE TABLE FOR KEY OF znept_qz_i_quiz_d\\question.

    METHODS get_instance_features FOR INSTANCE FEATURES
      IMPORTING keys REQUEST requested_features FOR question RESULT result.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR question RESULT result.
...
CLASS lhc_question IMPLEMENTATION.
  ...
  METHOD movequestion.
    ...
    LOOP AT it_keys INTO DATA(ls_keys).
      ...
      SELECT * FROM znept_qz_i_question_d INTO TABLE @DATA(lt_question_all)
  ...
  METHOD refreshquestion.
    ...
    DATA lt_question_create TYPE TABLE FOR CREATE znept_qz_i_quiz_d\_question.
    DATA lt_variant_create TYPE TABLE FOR CREATE znept_qz_i_quiz_d\\question\_variant.
