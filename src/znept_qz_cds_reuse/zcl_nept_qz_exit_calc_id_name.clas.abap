class ZCL_NEPT_QZ_EXIT_CALC_ID_NAME definition
  public
  final
  create public .
...
CLASS ZCL_NEPT_QZ_EXIT_CALC_ID_NAME IMPLEMENTATION.
  ...
  METHOD IF_SADL_EXIT_CALC_ELEMENT_READ~CALCULATE.
    ...
    CONSTANTS:
      BEGIN OF cs_calc_element,
        upload_by_name TYPE sadl_entity_element VALUE 'UPLOAD_BY_NAME',
    ...
    CHECK line_exists( it_requested_calc_elements[ table_line = cs_calc_element-upload_by_name ] ).
    ...
    SELECT upload_on upload_at test_id upload_by INTO TABLE lt_select
      ...
      WHERE test_id   = lt_calc_data-testid
        AND upload_on = lt_calc_data-uploadon
    ...
    IF sy-subrc = 0.
      ...
      LOOP AT lt_calc_data ASSIGNING FIELD-SYMBOL(<fs_calc_data>).
        ...
        READ TABLE lt_select INTO ls_select WITH KEY testid   = <fs_calc_data>-testid
