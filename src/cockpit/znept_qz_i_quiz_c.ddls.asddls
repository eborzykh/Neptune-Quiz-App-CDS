...
define root view entity ZNEPT_QZ_I_QUIZ_C
  ...
  composition [0..*] of ZNEPT_QZ_I_PART_C     as _Part

  association [0..*] to ZNEPT_QZ_I_VARIANT_C  as _Variant  on $projection.TestId = _Variant.TestId

  association [0..*] to ZNEPT_QZ_I_QUESTION_C as _Question on $projection.TestId = _Question.TestId
