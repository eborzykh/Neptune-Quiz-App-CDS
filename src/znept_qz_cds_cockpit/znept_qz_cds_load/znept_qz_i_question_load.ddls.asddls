...
define view entity ZNEPT_QZ_I_QUESTION_LOAD 
  as select from ZNEPT_QZ_I_QUESTION as _Question

  association     to parent ZNEPT_QZ_I_QUIZ_LOAD as _Quiz on  $projection.TestId = _Quiz.TestId

  association [1] to ZNEPT_QZ_I_PART_LOAD        as _Part on  $projection.TestId = _Part.TestId
                                                          and $projection.PartId = _Part.PartId

  composition [0..*] of ZNEPT_QZ_I_VARIANT_LOAD  as _Variant
