...
define view entity ZNEPT_QZ_I_VARIANT_LOAD
  ...
  association        to parent ZNEPT_QZ_I_QUESTION_LOAD as _Question on  $projection.TestId     = _Question.TestId
                                                                     and $projection.QuestionId = _Question.QuestionId

  association [1..1] to ZNEPT_QZ_I_QUIZ_LOAD            as _Quiz     on  $projection.TestId = _Quiz.TestId
